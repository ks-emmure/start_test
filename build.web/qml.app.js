'use strict'
var log = null
var $manifest$author$email = "ks.emmure@gmail.com"
var $manifest$author$name = "Konstantin Samsin"
...
//creating component Button
		_this$child0.$c($c.$c$_this$child0 = { })
		_this$child0._setId('begin')
		$this.addChild(_this$child0)
		var _this$child1 = new $src.Button($this)
		$c._this$child1 = _this$child1

//creating component Button
		_this$child1.$c($c.$c$_this$child1 = { })
		_this$child1._setId('exit')
		$this.addChild(_this$child1)
...
//assigning border.width to (${activeFocus} ? 1 : 0)
			_this$child0.border._replaceUpdater('width', function() { _this$child0.border.width = (_this$child0.activeFocus ? 1 : 0) }, [_this$child0,'activeFocus'])
...
//assigning color to 'black'
			_this$child0._removeUpdater('color'); _this$child0.color = 'black';
			_this$child0.__complete = function() { $src.Button.prototype.__complete.call(this)
this.setFocus();
}.bind(_this$child0)
			var $code$0 = function(key,event) {
	var exit = this._get('exit', true)

      exit.setFocus();
    }
			_this$child0.onPressed('Left', $code$0.bind(_this$child0))
			_this$child0.onPressed('Right', $code$0.bind(_this$child0))
			_this$child0.onPressed('Select', function(key,event) {
...
//assigning x to ((150) * ${context.virtualScale})
			_this$child1._replaceUpdater('x', function() { _this$child1.x = ((150) * _this$child1._context.virtualScale) }, [_this$child1._context,'virtualScale'])
//assigning y to ((15) * ${context.virtualScale})
			_this$child1._replaceUpdater('y', function() { _this$child1.y = ((15) * _this$child1._context.virtualScale) }, [_this$child1._context,'virtualScale'])
//assigning text to 'Выход'
			_this$child1._removeUpdater('text'); _this$child1.text = 'Выход';
//assigning focus to true
			_this$child1._removeUpdater('focus'); _this$child1.focus = true;
//assigning border.width to (${activeFocus} ? 1 : 0)
			_this$child1.border._replaceUpdater('width', function() { _this$child1.border.width = (_this$child1.activeFocus ? 1 : 0) }, [_this$child1,'activeFocus'])
//assigning border.color to "red"
			_this$child1.border._removeUpdater('color'); _this$child1.border.color = "red";
//assigning color to 'black'
			_this$child1._removeUpdater('color'); _this$child1.color = 'black';
			var $code$0 = function(key,event) {
	var begin = this._get('begin', true)

      begin.setFocus();
    }
			_this$child1.onPressed('Left', $code$0.bind(_this$child1))
			_this$child1.onPressed('Right', $code$0.bind(_this$child1))
 ...
 */
	...
	core.addProperty(ListPrototype, 'array', 'selectedItems')
	ListPrototype.__complete = function() {
	var back = this._get('back', true), listView = this._get('listView', true)
 ListBasePrototype.__complete.call(this)
this.selectedItems = [];
	...
	var $code$0 = function(key,event) {
	var listView = this._get('listView', true)

    listView.setFocus();
  }
	$core._protoOnKey(ListPrototype, 'Down', $code$0)
	$core._protoOnKey(ListPrototype, 'Up', $code$0)
...
//creating component Button
		...
		_this_child2$child0._setId('back')
...
//creating component Text
		...
		var _this_child2$child2 = new $src.ListView(_this$child2)
		$c._this_child2$child2 = _this_child2$child2

//creating component ListView
		_this_child2$child2.$c($c.$c$_this_child2$child2 = { })
		var _this_child2_child2$child0 = new $controls$mixins.OverflowMixin(_this_child2$child2)
		$c._this_child2_child2$child0 = _this_child2_child2$child0

//creating component OverflowMixin
		_this_child2_child2$child0.$c($c.$c$_this_child2_child2$child0 = { })

		_this_child2$child2.addChild(_this_child2_child2$child0)
		_this_child2$child2._setId('listView')
...
//creating component Rectangle
			...
			var delegate$child0 = new $core.Rectangle(delegate)
			$c.delegate$child0 = delegate$child0

//creating component Rectangle
			delegate$child0.$c($c.$c$delegate$child0 = { })
			var delegate_child0$child0 = new $core.Text(delegate$child0)
			$c.delegate_child0$child0 = delegate_child0$child0

//creating component Text
			delegate_child0$child0.$c($c.$c$delegate_child0$child0 = { })
			delegate_child0$child0._setId('title')
...
//assigning border.color to "red"
			...
			delegate.onPressed('Up', function(key,event) {
	var back = this._get('back', true)

          this.activeFocus = false;
          back.setFocus();
        }.bind(delegate))
			delegate.onPressed('Select', function(key,event) {
	var list = this._get('list', true), model = this._get('model', true), listView = this._get('listView', true)

          list.title = model.title;
          list.selectedItems.push(model.alias);
          listView.currentIndex = 0;
        }.bind(delegate))
			delegate.onPressed('Down', function(key,event) {
	var listView = this._get('listView', true), back = this._get('back', true)
...
//assigning width to (${parent.width} - 20)
			delegate$child0._replaceUpdater('width', function() { delegate$child0.width = (delegate$child0.parent.width - 20) }, [delegate$child0.parent,'width'])
//assigning x to ((10) * ${context.virtualScale})
			delegate$child0._replaceUpdater('x', function() { delegate$child0.x = ((10) * delegate$child0._context.virtualScale) }, [delegate$child0._context,'virtualScale'])
//assigning height to ((30) * ${context.virtualScale})
			delegate$child0._replaceUpdater('height', function() { delegate$child0.height = ((30) * delegate$child0._context.virtualScale) }, [delegate$child0._context,'virtualScale'])
//assigning y to ((10) * ${context.virtualScale})
			delegate$child0._replaceUpdater('y', function() { delegate$child0.y = ((10) * delegate$child0._context.virtualScale) }, [delegate$child0._context,'virtualScale'])
			delegate$child0.__complete = function() { $core.Rectangle.prototype.__complete.call(this)
this.style("pointer-events", "none");
}.bind(delegate$child0)

//setting up component Text
			var delegate_child0$child0 = $c.delegate_child0$child0
			delegate_child0$child0.$s($c.$c$delegate_child0$child0)
			delete $c.$c$delegate_child0$child0

//assigning width to ${parent.width}
			delegate_child0$child0._replaceUpdater('width', function() { delegate_child0$child0.width = delegate_child0$child0.parent.width }, [delegate_child0$child0.parent,'width'])
//assigning anchors.top to ${parent.top}
			delegate_child0$child0.anchors._replaceUpdater('top', function() { delegate_child0$child0.anchors.top = delegate_child0$child0.parent.top }, [delegate_child0$child0.parent,'top'])
//assigning text to ${model.title}
			delegate_child0$child0._replaceUpdater('text', function() { delegate_child0$child0.text = delegate_child0$child0._get('model').title }, [delegate_child0$child0._get('_delegate'),'_row'])
//assigning color to "white"
			delegate_child0$child0._removeUpdater('color'); delegate_child0$child0.color = "white";
//assigning clip to true
			delegate_child0$child0._removeUpdater('clip'); delegate_child0$child0.clip = true;
//assigning font.pixelSize to 24
			delegate_child0$child0.font._removeUpdater('pixelSize'); delegate_child0$child0.font.pixelSize = 24;
			delegate_child0$child0.__complete = function() { $core.Text.prototype.__complete.call(this)
this.style("text-overflow", "ellipsis");
}.bind(delegate_child0$child0)

			delegate_child0$child0.completed()
...
//assigning height to ((150) * ${context.virtualScale})
			delegate$child1._replaceUpdater('height', function() { delegate$child1.height = ((150) * delegate$child1._context.virtualScale) }, [delegate$child1._context,'virtualScale'])
//assigning y to ((40) * ${context.virtualScale})
			delegate$child1._replaceUpdater('y', function() { delegate$child1.y = ((40) * delegate$child1._context.virtualScale) }, [delegate$child1._context,'virtualScale'])
...
//assigning height to ((20 * 5) - 3)
			delegate_child1$child0._removeUpdater('height'); delegate_child1$child0.height = ((20 * 5) - 3);
//assigning anchors.top to ${parent.top}
...
//assigning text to ${model.description}
			delegate_child1$child0._replaceUpdater('text', function() { delegate_child1$child0.text = delegate_child1$child0._get('model').description }, [delegate_child1$child0._get('_delegate'),'_row'])
//assigning color to "white"
...
//assigning font.pixelSize to 16
			delegate_child1$child0.font._removeUpdater('pixelSize'); delegate_child1$child0.font.pixelSize = 16;
//assigning wrapMode to Text.WordWrap
			delegate_child1$child0._removeUpdater('wrapMode'); delegate_child1$child0.wrapMode = Text.WordWrap;
...
//assigning width to (((100) / 100 * ${parent.width}) - ((20) * ${context.virtualScale}))
			delegate$child2._replaceUpdater('width', function() { delegate$child2.width = (((100) / 100 * delegate$child2.parent.width) - ((20) * delegate$child2._context.virtualScale)) }, [delegate$child2.parent,'width',delegate$child2._context,'virtualScale'])
...
//assigning source to ("./images/" + ${model.image})
			delegate$child2._replaceUpdater('source', function() { delegate$child2.source = ("./images/" + delegate$child2._get('model').image) }, [delegate$child2._get('_delegate'),'_row'])
//assigning fillMode to Image.PreserveAspectFit
			delegate$child2._removeUpdater('fillMode'); delegate$child2.fillMode = Image.PreserveAspectFit;
			delegate$child2.__complete = function() { $core.Image.prototype.__complete.call(this)
this.style("pointer-events", "none");
...
//assigning anchors.right to ${parent.right}
			delegate$child3.anchors._replaceUpdater('right', function() { delegate$child3.anchors.right = delegate$child3.parent.right }, [delegate$child3.parent,'right'])
//assigning anchors.rightMargin to ((25) * ${context.virtualScale})
			delegate$child3.anchors._replaceUpdater('rightMargin', function() { delegate$child3.anchors.rightMargin = ((25) * delegate$child3._context.virtualScale) }, [delegate$child3._context,'virtualScale'])
//assigning width to 25
			delegate$child3._removeUpdater('width'); delegate$child3.width = 25;
//assigning height to 25
			delegate$child3._removeUpdater('height'); delegate$child3.height = 25;
//assigning source to (${model.source} ? ${model.source} : '')
			delegate$child3._replaceUpdater('source', function() { delegate$child3.source = (delegate$child3._get('model').source ? delegate$child3._get('model').source : '') }, [delegate$child3._get('_delegate'),'_row'])
...
//assigning border.width to (${activeFocus} ? 1 : 0)
			_this_child2$child0.border._replaceUpdater('width', function() { _this_child2$child0.border.width = (_this_child2$child0.activeFocus ? 1 : 0) }, [_this_child2$child0,'activeFocus'])
//assigning border.color to "red"
			_this_child2$child0.border._removeUpdater('color'); _this_child2$child0.border.color = "red";
//assigning color to 'black'
			_this_child2$child0._removeUpdater('color'); _this_child2$child0.color = 'black';
			_this_child2$child0.onPressed('Select', function(key,event) {
	var list = this._get('list', true), mainWindow = this._get('mainWindow', true), listModel = this._get('listModel', true), listView = this._get('listView', true)
...
//setting up component ListView
			...
			var ListView = _globals.src.ListView.prototype;
//assigning width to ((1000) * ${context.virtualScale})
			_this_child2$child2._replaceUpdater('width', function() { _this_child2$child2.width = ((1000) * _this_child2$child2._context.virtualScale) }, [_this_child2$child2._context,'virtualScale'])
//assigning height to ((310) * ${context.virtualScale})
			_this_child2$child2._replaceUpdater('height', function() { _this_child2$child2.height = ((310) * _this_child2$child2._context.virtualScale) }, [_this_child2$child2._context,'virtualScale'])
//assigning anchors.centerIn to ${parent}
...
//assigning animationDuration to 1
			_this_child2$child2._removeUpdater('animationDuration'); _this_child2$child2.animationDuration = 1;

//setting up component OverflowMixin
			var _this_child2_child2$child0 = $c._this_child2_child2$child0
			_this_child2_child2$child0.$s($c.$c$_this_child2_child2$child0)
			delete $c.$c$_this_child2_child2$child0

			var OverflowMixin = _globals.controls.mixins.OverflowMixin.prototype;
//assigning value to OverflowMixin.ScrollX
			_this_child2_child2$child0._removeUpdater('value'); _this_child2_child2$child0.value = OverflowMixin.ScrollX;

			_this_child2_child2$child0.completed()
 ...
 */
	var ListViewComponent = $src.ListView = function(parent, row) {
	...
	ListViewPrototype.componentName = 'src.ListView'
/** @const @type {number} */
 ...
 * @extends {$core.Object}
 */
	var BaseMixinComponent = $core.BaseMixin = function(parent, row) {
	...
	BaseMixinPrototype.componentName = 'core.BaseMixin'
	core.addProperty(BaseMixinPrototype, 'bool', 'enabled', true)
...
//=====[component controls.mixins.OverflowMixin]=====================
	...
	var OverflowMixinBaseComponent = $core.BaseMixin
	var OverflowMixinBasePrototype = OverflowMixinBaseComponent.prototype

/**
 * @constructor
 * @extends {$core.BaseMixin}
 */
